                                ...
                                <div class="card shadow-sm">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="btn-group">
                                                <a href="details.php?id=<?php echo $pro_row['id']; ?>&token=<?php echo hash_hmac('sha1', $pro_row['id'], KEY_TOKEN); ?>" class="btn btn-primary">Detalles</a>
                                            </div>
                                            <button class="btn btn-outline-primary" type="button" onClick="addProducto('<?php $pro_row['id'] ?>','<?php echo hash_hmac('sha1', $pro_row['id'], KEY_TOKEN); ?>')">Agregar al carrito</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
